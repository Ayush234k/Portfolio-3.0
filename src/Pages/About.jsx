  ...
  return (
    ...
    <div id="part-2">
        <div class="al">
            ...
            <div class="ac">
            I'm Ayush Singh, a third-year Computer Science student at KIIT University, where I'm immersing myself in the dynamic world of technology. My passion lies in web development, where I blend creativity with functionality to bring digital experiences to life.
            <br/><br/>
